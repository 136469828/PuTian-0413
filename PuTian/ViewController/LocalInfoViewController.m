...
#import "LocalInfoList.h"
#import "UserInfo.h"

@interface LocalInfoViewController ()<UITableViewDataSource,UITableViewDelegate>

@property (nonatomic,strong) PullToRefreshTableView *tableView;

@property (nonatomic,strong) LocalInfoList *infoList;
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title=@"本地资讯";
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveNotification:) name:kNotificationNameLocalInfoList object:nil];
    
    _infoList=[[LocalInfoList alloc] init];
    _infoList.notificationName=kNotificationNameLocalInfoList;
...
-(void)dealloc
{
    ...
    [[NSNotificationCenter defaultCenter] removeObserver:self name:kNotificationNameLocalInfoList object:nil];
}

-(void)receiveNotification:(NSNotification *)notification
{
    if([notification.name isEqualToString:kNotificationNameLocalInfoList])
    {
