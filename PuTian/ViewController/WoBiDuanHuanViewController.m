...
@interface WoBiDuanHuanViewController ()<UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate,UIGestureRecognizerDelegate,EScrollerViewDelegate>
...
@implementation WoBiDuanHuanViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title=@"沃币商品";
...
//            [user setObject:tmpstr forKey:@"use_point"];
            info.use_point = [[user objectForKey:@"use_point"] floatValue];
            [user synchronize];
            
            [cell setBuyerCount:info.use_point];
        }
    }
