...
#import "UserInfo.h"
@interface MeishiViewController ()<UITableViewDataSource,UITableViewDelegate>

@property (nonatomic,strong) PullToRefreshTableView *tableView;

@property (nonatomic,strong) MeishiInfoList *infoList;
...
//    self.navigationItem.title=@"本地资讯";
    ...
    _infoList=[[MeishiInfoList alloc] init];
