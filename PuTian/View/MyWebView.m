...
-(BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    {
        return [_myDelegate webView:self shouldStartLoadWithRequest:request navigationType:navigationType];
    }
    return YES;
}
...
-(void)webViewDidStartLoad:(UIWebView *)webView
{
    ...
    {
        [_myDelegate webViewDidStartLoad:self];
    }
}
...
-(void)webViewDidFinishLoad:(UIWebView *)webView
{
    ...
    if([_myDelegate respondsToSelector:@selector(webViewDidFinishLoad:)])
    {
        [_myDelegate webViewDidFinishLoad:self];
    }
}
...
-(void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
    ...
    {
        [_myDelegate webView:self didFailLoadWithError:error];
    }
}
...
{
    if([_myDelegate respondsToSelector:@selector(webViewDidScroll:)])
    {
        [_myDelegate webViewDidScroll:self];
    }
}
