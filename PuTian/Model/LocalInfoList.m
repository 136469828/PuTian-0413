...
//            self.slideType=SlideTypeNormal;
        ...
        NSString *urlString=[[NSString alloc] initWithFormat:@"%@?m=article&a=getlist&term_id=%d&uid=%d&pindex=%d&psize=%d",URL_Server,2,_uid,tmpPageIndex,_pageSize];
        NSLog(@"JCK%@",urlString);
